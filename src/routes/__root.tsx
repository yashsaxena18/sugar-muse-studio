  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-7xl font-bold text-gradient-festive">404</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Geeta Aggarwal Sweets — Premium Indian Mithai & Namkeen" },
      {
        name: "description",
        content:
          "Handcrafted Indian sweets, namkeen and festive gift boxes. Traditional recipes, premium ingredients, prepared fresh every day.",
      },
      { name: "theme-color", content: "#b9892a" },
